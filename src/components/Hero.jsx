...
export function Hero() {
  return (
    ...
    >
      ...
      >
        <motion.h1
          className="text-[45px] sm:text-[40px] xs:text-[35px] font-semibold leading-[55px] sm:leading-[50px] xs:leading-[45px]"
        ...
        <motion.p
          className="text-[18px] sm:text-[16px] xs:text-[14px] leading-[30px] sm:leading-[28px] xs:leading-[24px]"
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
        ...
        <motion.div
          className="flex flex-col sm:flex-row gap-[25px] text-[22px] font-[400] sm:gap-4 sm:text-[20px] xs:text-[18px]"
          initial={{ opacity: 0, y: 50 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <motion.a
            ...
            className="px-[35px] py-[20px] sm:px-[25px] sm:py-[15px] xs:px-[20px] xs:py-[12px] rounded-[50px] bg-[linear-gradient(135deg,#166E48_5%,#33FFA9_100%)] cursor-pointer animate-pulse text-center"
          >
            Download my CV
          </motion.a>
          ...
          <AnchorLink href="#portfolio" offset={50}>
            <motion.div
              ...
              whileTap={{ scale: 0.95 }}
              className="px-[50px] py-[20px] sm:px-[35px] sm:py-[15px] xs:px-[25px] xs:py-[12px] rounded-[50px] border-2 border-white cursor-pointer transition text-center"
            >
              View Projects
            </motion.div>
          </AnchorLink>
      ...
      <div className="flex flex-col items-center gap-10 sm:gap-6">
        <motion.img
          src={profile}
          alt="Hero"
          className="w-[400px] sm:w-[300px] xs:w-[250px] h-auto rounded-[2000px]"
          initial={{ opacity: 0, scale: 0.8 }}
          animate={{ opacity: 1, scale: 1 }}
          transition={{ delay: 1.2, duration: 0.8 }}
        />
        <div className="flex gap-6 sm:gap-4 xs:gap-3">
          <a href="https://github.com/SamQS" target="_blank" rel="noopener noreferrer">
            <motion.img
              src={github}
              alt="github"
              className="w-[50px] sm:w-[40px] xs:w-[35px] h-auto rounded-[2000px]"
